		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">員工密碼修改</h1>
					<!-- DataTales Example -->
							...
							<div class="table-responsive">
								...
								<table class="table table-bordered" id="dataTable" width="100%"
									...
									<FORM METHOD="post" ACTION="emp.do" name="form1">
										<tr>
											<th><i class="fa-solid fa-key"></i>舊密碼</th>
											<td><input type="password" name="oldPassword" size="45" /></td>
										</tr>
										<tr>
											<th><i class="fa-solid fa-unlock-keyhole"></i>新密碼</th>
											<td><input type="password" name="newPassword" size="45" /></td>
										</tr>
										<tr>
											<th><i class="fa-solid fa-unlock-keyhole"></i>確認新密碼</th>
											<td><input type="password" name="newPassword2" size="45" /></td>
										</tr>
										<tr>
											<td><input type="hidden" name="action" value="check_change"></td>
											<td><input type="submit" value="送出新增" style="background-color:#fae1a7"></td>
										</tr>
									</FORM>
								</table>
							</div>
