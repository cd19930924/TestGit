		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">員工權限群組管理</h1>
					<p class="mb-4">
						指派群組、瀏覽群組
					</p>
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">員工權限群組</h6>
						</div>
						<div class="card-body">
							<div style="display: flex;">
										...
										<tbody>
											<c:forEach var="empVO" items="${empList}">
												<tr>
													...
													<td>
														<button onclick="choose(${empVO.empId},'${empVO.empAuthNo}')">選擇</button>
													</td>
												</tr>
											</c:forEach>
										</tbody>
								...
								<div style="flex: 1; padding-top: 20%; padding-left: 10%;">
									<form action="empAuth" method="post">
										...
										<div>
											<label for="id">員工編號</label><br> 
											<input type="text" id="id" name="empId" placeholder="員工編號" style="width: 200px;">
										</div>
										<br>
										<div>
											<label>指派群組</label><br> 
											<select id="select" name="empAuthNo" style="width: 200px;">
												<option value="none" disabled selected>請選擇</option>
										...
										<div style="padding-left: 18%;">
											...
											<button class="function2" type="submit" disabled>更改</button>

											<button id="empty" type="button">清空</button>
										</div>
									</form>
								</div>
							</div>
