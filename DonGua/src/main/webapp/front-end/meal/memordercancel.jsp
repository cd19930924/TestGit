...
<%
	...
	List<MealOrderVO> list = mealOrderSvc.findByMemIdAndStatus(id, "4");
            ...
            <div class="row w-100">
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href='<%=request.getContextPath()%>/front-end/meal/memordercancel.jsp'>已取消</a>
                        </li>
                    </ul>
