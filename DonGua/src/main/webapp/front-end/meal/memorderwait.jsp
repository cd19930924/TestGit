...
<%
	...
	List<MealOrderVO> list = mealOrderSvc.findByMemIdAndStatus(id, "0");
            ...
            <div class="row w-100">
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href='<%=request.getContextPath()%>/front-end/meal/memorderwait.jsp'>待執行</a>
                        </li>
                        <li class="nav-item">
											...
											<td>
												<form action="order.do" method="post">
													<input type="hidden" name="mealOrderId" value="${mealOrderVO.mealOrderId}"> 
														<input type="hidden" name="action" value="cancel_order_onwait">
