...
<%
	...
	List<MealOrderVO> list = mealOrderSvc.findByMemIdAndStatus(id, "1");
            ...
            <div class="row w-100">
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href='<%=request.getContextPath()%>/front-end/meal/memorderdoing.jsp'>執行中</a>
                        </li>
                        <li class="nav-item">
