		...
		<div class="container">
			<div class="row w-100">
				<div class="col-lg-12 col-md-12 col-12">
					<h2 class="mb-2 mt-5 fw-bold">服務簡介</h2>
					<jsp:useBean id="intro" scope="page"
						class="com.infomanage.model.InfoService" />

					<div class="table-responsive">
						<c:forEach var="newslist" items="${intro.validIntro}">

							<div class="gallery">
									<p>${newslist.name}</p>
								<div class="desc">${newslist.content}</div>
							</div>
						</c:forEach>
					</div>
				</div>
